...
/*按键余量版本*/
  /*实验编号+按键*/
  button[EXPERNUMPLUS_BUTTON].start_x = 0;
  button[EXPERNUMPLUS_BUTTON].start_y = COLOR_BLOCK_HEIGHT * 0;
  button[EXPERNUMPLUS_BUTTON].end_x = 100;
  button[EXPERNUMPLUS_BUTTON].end_y = COLOR_BLOCK_HEIGHT * 3;
  /*实验编号-按键*/
  button[EXPERNUMPSUB_BUTTON].start_x = 180;
  button[EXPERNUMPSUB_BUTTON].start_y = COLOR_BLOCK_HEIGHT * 0;
  button[EXPERNUMPSUB_BUTTON].end_x = 280;
  button[EXPERNUMPSUB_BUTTON].end_y = COLOR_BLOCK_HEIGHT * 3;



  /*速度+按键*/
  button[SPEEDPLUS_BUTTON].start_x = 480;
  button[SPEEDPLUS_BUTTON].start_y = COLOR_BLOCK_HEIGHT * 7;
  button[SPEEDPLUS_BUTTON].end_x = 580;
  button[SPEEDPLUS_BUTTON].end_y = COLOR_BLOCK_HEIGHT * 10;
  /*速度-按键*/
  button[SPEEDSUB_BUTTON].start_x = 660;
  button[SPEEDSUB_BUTTON].start_y = COLOR_BLOCK_HEIGHT * 7;
  button[SPEEDSUB_BUTTON].end_x = 760;
  button[SPEEDSUB_BUTTON].end_y = COLOR_BLOCK_HEIGHT * 10;

  
  /*间隙+按键*/
  button[GAPPLUS_BUTTON].start_x = 480;
  button[GAPPLUS_BUTTON].start_y = COLOR_BLOCK_HEIGHT * 2;
  button[GAPPLUS_BUTTON].end_x = 580;
  button[GAPPLUS_BUTTON].end_y = COLOR_BLOCK_HEIGHT * 5;
   /*间隙-按键*/
  button[GAPSUB_BUTTON].start_x = 660;
  button[GAPSUB_BUTTON].start_y = COLOR_BLOCK_HEIGHT * 2;
  button[GAPSUB_BUTTON].end_x = 760;
  button[GAPSUB_BUTTON].end_y = COLOR_BLOCK_HEIGHT * 5;

  //  /*电压+按键---第13行*/
  button[VOLTAGEPLUS_BUTTON].start_x = 480;
  button[VOLTAGEPLUS_BUTTON].start_y = COLOR_BLOCK_HEIGHT * 12;
  button[VOLTAGEPLUS_BUTTON].end_x = 580;
  button[VOLTAGEPLUS_BUTTON].end_y = COLOR_BLOCK_HEIGHT * 15;  
  /*电压-按键---第13行*/
  button[VOLTAGESUB_BUTTON].start_x = 660;
  button[VOLTAGESUB_BUTTON].start_y = COLOR_BLOCK_HEIGHT * 12;
  button[VOLTAGESUB_BUTTON].end_x = 760;
  button[VOLTAGESUB_BUTTON].end_y = COLOR_BLOCK_HEIGHT * 15; 
  
/*按键无余量版本*/
//  /*实验编号+按键*/
//  button[EXPERNUMPLUS_BUTTON].start_x = 20;
//  button[EXPERNUMPLUS_BUTTON].start_y = COLOR_BLOCK_HEIGHT * 1;
//  button[EXPERNUMPLUS_BUTTON].end_x = 90;
//  button[EXPERNUMPLUS_BUTTON].end_y = COLOR_BLOCK_HEIGHT * 2;
//  /*实验编号-按键*/
//  button[EXPERNUMPSUB_BUTTON].start_x = 180;
//  button[EXPERNUMPSUB_BUTTON].start_y = COLOR_BLOCK_HEIGHT * 1;
//  button[EXPERNUMPSUB_BUTTON].end_x = 230;
//  button[EXPERNUMPSUB_BUTTON].end_y = COLOR_BLOCK_HEIGHT * 2;



//  /*速度+按键*/
//  button[SPEEDPLUS_BUTTON].start_x = 516;
//  button[SPEEDPLUS_BUTTON].start_y = COLOR_BLOCK_HEIGHT * 8;
//  button[SPEEDPLUS_BUTTON].end_x = 567;
//  button[SPEEDPLUS_BUTTON].end_y = COLOR_BLOCK_HEIGHT * 9;
//  /*速度-按键*/
//  button[SPEEDSUB_BUTTON].start_x = 691;
//  button[SPEEDSUB_BUTTON].start_y = COLOR_BLOCK_HEIGHT * 8;
//  button[SPEEDSUB_BUTTON].end_x = 738;
//  button[SPEEDSUB_BUTTON].end_y = COLOR_BLOCK_HEIGHT * 9;

//  
//  /*间隙+按键*/
//  button[GAPPLUS_BUTTON].start_x = 516;
//  button[GAPPLUS_BUTTON].start_y = COLOR_BLOCK_HEIGHT * 3;
//  button[GAPPLUS_BUTTON].end_x = 567;
//  button[GAPPLUS_BUTTON].end_y = COLOR_BLOCK_HEIGHT * 4;
//   /*间隙-按键*/
//  button[GAPSUB_BUTTON].start_x = 691;
//  button[GAPSUB_BUTTON].start_y = COLOR_BLOCK_HEIGHT * 3;
//  button[GAPSUB_BUTTON].end_x = 738;
//  button[GAPSUB_BUTTON].end_y = COLOR_BLOCK_HEIGHT * 4;

//  //  /*电压+按键---第13行*/
//  button[VOLTAGEPLUS_BUTTON].start_x = 516;
//  button[VOLTAGEPLUS_BUTTON].start_y = COLOR_BLOCK_HEIGHT * 13;
//  button[VOLTAGEPLUS_BUTTON].end_x = 567;
//  button[VOLTAGEPLUS_BUTTON].end_y = COLOR_BLOCK_HEIGHT * 14;  
//  /*电压-按键---第13行*/
//  button[VOLTAGESUB_BUTTON].start_x = 691;
//  button[VOLTAGESUB_BUTTON].start_y = COLOR_BLOCK_HEIGHT * 13;
//  button[VOLTAGESUB_BUTTON].end_x = 738;
//  button[VOLTAGESUB_BUTTON].end_y = COLOR_BLOCK_HEIGHT * 14; 
...
void Touch_Button_Down(uint16_t x,uint16_t y)
{
    ...
    /* 1-检测是否按下开始键 */
    //if(x<=button[START_STOP_BUTTON].end_x && y<=button[START_STOP_BUTTON].end_y && y>=button[START_STOP_BUTTON].start_y && x>=button[START_STOP_BUTTON].start_x )
    if (x<= 500 && y<= (COLOR_BLOCK_HEIGHT * 19) && y >= (COLOR_BLOCK_HEIGHT * 16) && x >= 300)
    {   
       if (DeviceStatus == DEVICE_RUNNING)
       {
          DeviceStatus = DEVICE_STOPPED;       /*设置程序运行状态为停止*/
          LED_RED;
       }
       else if (DeviceStatus == DEVICE_STOPPED)
       {
          DeviceStatus = DEVICE_RUNNING;       /*设置程序运行状态为运行*/
          LED_GREEN;
       }
    ...
    /* 2-检测是否按下速度+键*/
    else if(x<=button[SPEEDPLUS_BUTTON].end_x && y<=button[SPEEDPLUS_BUTTON].end_y && y>=button[SPEEDPLUS_BUTTON].start_y && x>=button[SPEEDPLUS_BUTTON].start_x )
    {
       if (StirSpeed < 3000)
       {
          StirSpeed += 500;
    ...
    /* 3-检测是否按下速度-键*/
    else if(x<=button[SPEEDSUB_BUTTON].end_x && y<=button[SPEEDSUB_BUTTON].end_y && y>=button[SPEEDSUB_BUTTON].start_y && x>=button[SPEEDSUB_BUTTON].start_x )
    {
       if (StirSpeed > 0)
       {
          StirSpeed -= 500;
    ...
    /* 4-检测是否按下间隙+键*/
    else if(x<=button[GAPPLUS_BUTTON].end_x && y<=button[GAPPLUS_BUTTON].end_y && y>=button[GAPPLUS_BUTTON].start_y && x>=button[GAPPLUS_BUTTON].start_x )
    {
       if (MachGap < 20.0f && (DeviceStatus == DEVICE_STOPPED))
       {
          MachGap += 0.5f;
          LED3_TOGGLE;
       }
    ...
    /* 5-检测是否按下间隙-键*/
    else if(x<=button[GAPSUB_BUTTON].end_x && y<=button[GAPSUB_BUTTON].end_y && y>=button[GAPSUB_BUTTON].start_y && x>=button[GAPSUB_BUTTON].start_x )
    {
       if (MachGap > 0.0f &&(DeviceStatus == DEVICE_STOPPED))
       {
          MachGap -= 0.5f;
          LED3_TOGGLE;
       }
    ...
    /* 6-检测是否按下电压+键*/
    else if(x<=button[VOLTAGEPLUS_BUTTON].end_x && y<=button[VOLTAGEPLUS_BUTTON].end_y && y>=button[VOLTAGEPLUS_BUTTON].start_y && x>=button[VOLTAGEPLUS_BUTTON].start_x )
    {
       if (MachVoltage < 40.0)
       {
          MachVoltage += 0.5;
    ...
    /* 7-检测是否按下电压-键*/
    else if(x<=button[VOLTAGESUB_BUTTON].end_x && y<=button[VOLTAGESUB_BUTTON].end_y && y>=button[VOLTAGESUB_BUTTON].start_y && x>=button[VOLTAGESUB_BUTTON].start_x )
    {
       if (MachVoltage > 0.0)
       {
          MachVoltage -= 0.5;
    ...
    /* 7-检测是否按下实验编号+键*/
    else if(x<=button[EXPERNUMPLUS_BUTTON].end_x && y<=button[EXPERNUMPLUS_BUTTON].end_y && y>=button[EXPERNUMPLUS_BUTTON].start_y && x>=button[EXPERNUMPLUS_BUTTON].start_x )
    {
       if (ExperNum < 40 && (DeviceStatus == DEVICE_STOPPED))
       {
          ExperNum += 1;
          LED3_TOGGLE;
       }
    ...
    /* 8-检测是否按下实验编号-键*/
    else if(x<=button[EXPERNUMPSUB_BUTTON].end_x && y<=button[EXPERNUMPSUB_BUTTON].end_y && y>=button[EXPERNUMPSUB_BUTTON].start_y && x>=button[EXPERNUMPSUB_BUTTON].start_x )
    {
       if (ExperNum > 0 && (DeviceStatus == DEVICE_STOPPED))
       {
          ExperNum -= 1;
          LED3_TOGGLE;
       }
...
static void GTP_Touch_Down(int32_t id,int32_t x,int32_t y,int32_t w)
{
    ...
    //static unsigned int Pre_Touch_X = -1;
    //static unsigned int Pre_Touch_Y = -1;
    ...
    /* 处理触摸按钮，用于触摸画板 */
    //if (((x - Pre_Touch_X) * (x - Pre_Touch_X)) >= 100)
    if (IsTouch == 0)
    {
