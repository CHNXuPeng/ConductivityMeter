...
/*================================用户自定义====================================*/
#define COLOR_BLOCK_HEIGHT  24     //每行的高度
#define COLOR_BLOCK_HALF_HEIGHT  12     //每半行的高度
#define TOUCH_TAB           10          //为了按键预留多出的空间
/*开始/停止*/
#define START_STOP_BUTTON 0
/*搅拌速度加减*/
#define SPEEDPLUS_BUTTON 1
#define SPEEDSUB_BUTTON 2
/*加工间隙加减*/
#define GAPPLUS_BUTTON 3
#define GAPSUB_BUTTON 4
/*加工电压加减*/
#define VOLTAGEPLUS_BUTTON 5
#define VOLTAGESUB_BUTTON 6
/*实验编号*/
#define EXPERNUMPLUS_BUTTON 7
#define EXPERNUMPSUB_BUTTON 8
/*按键数量*/
#define BUTTON_NUM 9
...
extern unsigned int IsTouch;
extern unsigned int  ExperNum;
...
#define GTP_MAX_TOUCH         2       //将多点触控关闭，改为单点
